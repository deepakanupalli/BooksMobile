...
import  com.books.library.service.LIBRARYQueryExecutorService;
import com.wavemaker.runtime.data.model.CustomQuery;
import com.wavemaker.runtime.data.exception.QueryParameterMismatchException;
import com.wordnik.swagger.annotations.*;

@RestController(value = "LIBRARY.QueryExecutionController")
@Api(value = "/LIBRARY/queryExecutor", description = "Controller class for query execution")
@RequestMapping("/LIBRARY/queryExecutor")
public class QueryExecutionController {

	private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

	@Autowired
	private LIBRARYQueryExecutorService queryService;
	
	@RequestMapping(value = "/queries/updateBookStatus", method = RequestMethod.GET)
	@ApiOperation(value = "Process request to execute queries")
	public int executeUpdateBookStatus(
			@RequestParam(value="readStatus", required=false) java.lang.Integer readStatus,
			@RequestParam(value="id", required=false) java.lang.Integer id
		)
 throws QueryParameterMismatchException{
	...
	@RequestMapping(value = "/queries/updateBookRating", method = RequestMethod.GET)
	@ApiOperation(value = "Process request to execute queries")
	public int executeUpdateBookRating(
			@RequestParam(value="rating", required=false) java.lang.Integer rating,
			@RequestParam(value="id", required=false) java.lang.Integer id
		)
 throws QueryParameterMismatchException{
			LOGGER.debug("Executing named query updateBookRating");
		int result = queryService.executeUpdateBookRating( rating , id );
		LOGGER.debug("got the result of named query {}", result);
		return result;
	}
